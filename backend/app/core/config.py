...
class Settings(BaseSettings):
    ...
    # No default on purpose: these sign JWTs and QR codes, so a
    # misconfigured deploy must fail to boot instead of silently running
    # with a guessable, publicly-known fallback secret.
    jwt_secret_key: str
